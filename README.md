...
- Due to the issue described above and an implementation safety measure, my bitmap image does not look like horizontal lines of the same color due to a slight offset. 
